...
function pano2vrSkin(player,base) {
	...
	this.addSkin=function() {
		...
		hs+='width : 5.5%;';
		hs+='pointer-events:none;';
		hs+='max-width:80px; min-width:60px; min-height:360px;';
		el.setAttribute('style',hs);
		el.style.transformOrigin='50% 50%';
		...
		hs+='width : 100%;';
		hs+='pointer-events:none;';
		hs+='min-height:60px; max-height:80px;';
		el.setAttribute('style',hs);
		el.style.transformOrigin='50% 50%';
		...
		hs+='width : auto;';
		hs+='pointer-events:auto;';
		hs+='letter-spacing:1px; font-family: \"Noto Sans KR\", sans-serif;';
		el.setAttribute('style',hs);
		el.style.transformOrigin='50% 50%';
		hs ='';
		hs += 'box-sizing: border-box;';
		...
		me._text_1.ggUpdateText=function() {
			var params = [];
			var hs = player._("\uc6b8\uc0b0\ub2e4\uc6b4\uc8fc\ud0dd\uc9c0\uad6c", params);
			if (hs!=this.ggText) {
				this.ggText=hs;
				this.ggTextDiv.innerHTML=hs;
				if (this.ggUpdatePosition) this.ggUpdatePosition();
		...
		me._text_9.ggUpdateText=function() {
			var params = [];
			var hs = player._("\uc548\ub155\ud558\uc138\uc694. \n\ud558\uc774\ud37c\ub9ac\uc5bc\ub9ac\uc998 \uc0ac\uc774\ubc84\ubaa8\ub378\ud558\uc6b0\uc2a4, \uc2e4\uc0ac VR, \ud56d\uacf5 VR \ucee8\ud150\uce20\ub97c \uc81c\uc791\ud558\ub294 \uc5b8\ud53d\uc158\uc785\ub2c8\ub2e4. \n\n\ud574\ub2f9 \ud56d\uacf5 VR\uc740 \uc6b8\uc0b0\ub2e4\uc6b4\uc8fc\ud0dd\uc9c0\uad6c\uc758 \uc0c1\ud669\uc744 \ud655\uc778\ud574 \ubcf4\uc2e4 \uc218 \uc788\ub3c4\ub85d \uc5f0\ucd9c\ud55c \uac83\uc785\ub2c8\ub2e4. \n\uacbd\ud5d8\ud574 \ubcf4\uc9c0 \ubabb\ud55c \uc704\uce58\uc5d0\uc11c \ud55c\ub208\uc5d0 \ud30c\uc545\ud574\ubcfc \uc218 \uc788\ub294 \ud56d\uacf5VR\n\uc5ec\ub7ec\ubd84\uc758 \ud604\uba85\ud55c \uacb0\uc815\uc5d0 \ub3c4\uc6c0\uc744 \ub4dc\ub9b4 \uc218 \uc788\uae38 \ud76c\ub9dd\ud569\ub2c8\ub2e4. \n\n------\n\ud56d\uacf5 VR \ubc0f \uc0ac\uc774\ubc84 \ubaa8\ub378\ud558\uc6b0\uc2a4 \uc81c\uc791\ubb38\uc758\n- \uc0c1\ud638\uba85 : \uc5b8\ud53d\uc158\n- \uace0\uac1d\uc13c\ud130 : 1566-5297\n- \ud648\ud398\uc774\uc9c0 : www.unfiction.kr ", params);
			if (hs!=this.ggText) {
				this.ggText=hs;
				this.ggTextDiv.innerHTML=hs;
				if (this.ggUpdatePosition) this.ggUpdatePosition();
		...
		hs+='width : 5.5%;';
		hs+='pointer-events:none;';
		hs+='max-width:80px; min-width:60px; min-height:60px; max-height:80px;';
		el.setAttribute('style',hs);
		el.style.transformOrigin='50% 50%';
		...
		me._container_3.logicBlock_position = function() {
			var newLogicStatePosition;
			if (
				((player.getViewerSize().width <= 670))
			)
			...
			if (me._container_3.ggCurrentLogicStatePosition != newLogicStatePosition) {
				me._container_3.ggCurrentLogicStatePosition = newLogicStatePosition;
				me._container_3.style.transition='right 0s, top 0s, transform 0s';
				if (me._container_3.ggCurrentLogicStatePosition == 0) {
					me._container_3.style.right='1%';
					me._container_3.style.top='15%';
				}
				else {
					me._container_3.style.right='1%';
					me._container_3.style.top='13%';
				}
			}
		}
		me._container_3.logicBlock_position();
		me._container_3.logicBlock_scaling = function() {
			...
			if (me._container_3.ggCurrentLogicStateScaling != newLogicStateScaling) {
				...
				if (me._container_3.ggCurrentLogicStateScaling == 0) {
					me._container_3.ggParameter.sx = 0.8;
					me._container_3.ggParameter.sy = 0.8;
					me._container_3.style.transform=parameterToTransform(me._container_3.ggParameter);
					skin.updateSize(me._container_3);
				}
				else {
		...
		me._container_3.logicBlock_scaling();
		...
		me._container_3.appendChild(me._timer_1);
